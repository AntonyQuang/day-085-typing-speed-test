...
class TypingTest:
    def __init__(self):
        ...
        # Typing Zone
        self.typer = Entry(self.body, width=50, justify="center")
        ...
        self.restart_btn.grid(row=3, column=4)
    ...
    def reset(self):
        ...
        self.typer.config(state="normal")
        self.typer.bind("<KeyPress>", self.start)
        self.typer.bind("<BackSpace>", self.backspace)
    ...
    def check_char(self, event):
        ...
        if char_typed == " ":
            ...
            self.words.tag_config("correct_char", background="blue", foreground="white")
        else:
            ...
            self.words.tag_config("incorrect_char", background="red", foreground="white")
        self.position += 1
